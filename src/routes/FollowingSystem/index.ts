...
router.patch('/users/followers/:followerId', expressWrapper(isAuth), expressWrapper(FollowingSystem.follower))
router.patch('/users/following/:followingId', expressWrapper(isAuth), expressWrapper(FollowingSystem.following))
